  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const templateParams = {
        to_email: 'elidanielp9@gmail.com',
      ...
      await emailjs.send(
        'service_44en6db', // Reemplaza con tu Service ID de EmailJS
        'template_r0rmi0i', // Reemplaza con tu Template ID de EmailJS
        templateParams,
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg relative">
        ...
        <div className="p-6 md:p-8">
          ...
          <p className="text-gray-600 mb-6">
            Completa el formulario y nos pondremos en contacto contigo para discutir cómo podemos ayudarte con {serviceTitle}.
          </p>
